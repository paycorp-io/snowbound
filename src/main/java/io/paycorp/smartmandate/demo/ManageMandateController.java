...
public class ManageMandateController {
    ...
    public String getAmend(Model model) {
        Map<String, String> amountTpMap = AmendMandate.Amend.amountTpMap();
        ...
        model.addAttribute("amountRpMap", amountTpMap);
    ...
    public String postAmend(@RequestParam String utilityCode, @RequestParam String referenceNumber,
            @RequestParam String categoryCode, @RequestParam String amountTp, @RequestParam String colltnAmt,
            @RequestParam String frqcy, @RequestParam String firstCollectionDate, @RequestParam String finalCollectionDate,
